...
The competency *colour* is intentionally **not** stored: it is a deterministic
function of the competency label / GPA (:mod:`sars.competency`), computed at
render time, so only the label and GPA are data.
"""
