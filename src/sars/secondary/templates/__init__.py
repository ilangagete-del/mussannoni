...
from ...schema import TYPE_BY_SCHEMA as _TYPE_BY_SCHEMA
...
#: schema class -> report_type. Re-exported from :mod:`sars.schema`, where it now
#: lives: it describes schema classes, which have no education stage.
TYPE_BY_SCHEMA = _TYPE_BY_SCHEMA
